  ...
  // ADMIN
   {
    ...
    children: [
      ...
      },
      {
        path: 'solicitudes/:id',
        loadComponent: () =>
          import('./features/admin/admin-solicitud-detalle').then(
...

      {
        path: 'reservas',
        loadComponent: () =>
          import('./features/admin/admin-reservas').then(
      ...
      },
      {
        path: 'reservas/:id',
        loadComponent: () =>
          import('./features/admin/admin-reserva-detalle').then(
...

      {
        path: 'reportes',
        loadComponent: () =>
          import('./features/admin/admin-reportes/admin-reportes').then(
