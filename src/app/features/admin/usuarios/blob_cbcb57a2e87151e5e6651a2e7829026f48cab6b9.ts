...
export interface AdminUsuarioPerfil {
  ...
  // ✅ Solo lectura: se muestra si existe (el admin NO la edita)
  direccion_principal?: {
    id?: number;
...
/**
 * ✅ UPDATE: el admin solo cambia cuenta + datos básicos del perfil
 * ❌ NO dirección
 * ❌ NO rut (y tu serializer ya lo bloquea)
 */
...
/**
 * ✅ CREATE: crea cuenta + perfil básico
 * ❌ NO dirección
 */
